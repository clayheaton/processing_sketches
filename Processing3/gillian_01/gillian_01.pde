...
void draw (){ // run repeatedly
  ...
  fill(random(235),200); // make the fill mostly red and green, and a bit translucent
...
void mousePressed(){ // on mouse-click, run the following code
  background(4,52,118,100); //reset the background to how it was
   image(img,300,0); //importing moon image
