/*
 ...
 Image Quilting, by Clay Heaton, 2015.
...
PImage grass, grass2, mars, mars2, water, apples, muddywater, gravel, gravel2, gravel3;

// Textures to use for the run of the sketch
// Assign them in the setup() function below (Processing requirement)
PImage texture1;
PImage texture2;

// % chance that a pixel will be drawn from texture1 vs. texture2
float texture1Chance = 0.05;

int sampleSize       = 128; // Side length of samples taken from original source
...
void draw() {
  ...
  ///////////////////////////////////////////////////////
  ////// End of Stuff to do when the image is complete //
  ///////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////
  ////// End of Stuff to do to create the image /////////
  ///////////////////////////////////////////////////////
}
